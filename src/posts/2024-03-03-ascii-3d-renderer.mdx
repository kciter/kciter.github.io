...
<Video client:load src="/images/2024-03-03-ascii-3d-renderer/rasterize.mp4" width="80%" caption="한 짤 요약" autoPlay muted loop playsInline />
...
<div style={{boxShadow: '1px 1px 2px 2px rgba(0, 0, 0, 0.1)', borderRadius: 4, padding: 16, width: '80%', margin: '0 auto 8px auto'}}>
  <ASCII3DRenderer client:visible />
</div>
